...
<head>
<?php
$_SESSION['selectedCApplication']=$_REQUEST['selectedApplication'];
?>
...
<tr>
    <td height="156" class="rightTitleCell">
            <p>Waiting for a new Response for Questionnaire <?php echo $_SESSION['selectedCApplication'];?></p>
    </td>
</tr>
<tr>
    <td class="subCatCells">
        <iframe src="responseChecker.php" scrolling="no" width="100%" frameborder="0" height="100%"></iframe>
    </td>
</tr>
</table>
</td>
