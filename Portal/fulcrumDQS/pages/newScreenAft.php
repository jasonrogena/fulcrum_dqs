...
<?php
    ...
    if(isset ($_REQUEST['submitForm']))
    {
        ...
        else if($_REQUEST['screenType']==5)
        {
            ...
            if($_REQUEST['openEndedResponseLength']>250 || $_REQUEST['openEndedResponseLength']<1)
            {
                $flag=1;
                $_SESSION['oEQRLengthExcessFlag']=1;
            }
            else
            {
                $_SESSION['oEQRLengthExcessFlag']=0;
            }
        }
        ...
        if($flag==0)
        {
            echo "<meta http-equiv=\"refresh\" content=\"0;URL=../phpScripts/addScreenAft.php\" />";
        }
        $_SESSION['flag']=$flag;
    }
    else
...
<form action="newScreenAft.php" method="post">
<tr>
    <td class="subCatCells" height="45px">
            ...
            <div id="singleSelect" style="display: none">
                ...
                <table width="100%">
                    <tr>
                        <td height="220px">
                            <iframe src="addChoiceSingleSelect.php" scrolling="yes" width="100%" frameborder="0" height="100%"></iframe>
                        </td>
                    </tr>
                </table>
                    </td>
                ...
                <table width="100%"><tr><td width="36%">
                    ...
                    <input type="text" name="wOSNextScreen" size="2" title="enter the screen number for the next screen here" value="<?php
        ...
        <div id="listQuery" style="display: none">
            ...
            <tr><td height="45px">
                ...
                <td>
                <input type="text" size="2" name="listSize" value="<?php
            ...
            <tr><td height="45px">
                ...
                <td>
                <input type="text" size="2" name="listResponseLength" value="<?php
        ...
        <div id="openEndedQuery" style="display: none">
            ...
            <tr><td height="45px">
                ...
                else if(isset ($_SESSION['oEQRLengthExcessFlag']) && $_SESSION['oEQRLengthExcessFlag']==1)
                {
        ...
        <div id="ranking" style="display: none">
            ...
            <table width="100%"><tr><td width="15%">
                ...
                <td width="85%">
                <input type="text" size="2" name="rankingSizeOfList" value="<?php
        ...
        <div style="height:30px; text-align:right; padding-right:200px">
            <input type="submit" value="Create another Screen" name="submitForm"/>
        </div>
        <div style="height:30px; text-align:right; padding-right:200px">
                <input type="submit" value="Am done creating the Section" name="submitForm"/>
        </div>
    </td>
</tr>
</form>
